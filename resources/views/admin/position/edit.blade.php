            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="custom-validation" action="{{ route('position.update', $position) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <textarea name="description" class="form-control" rows="5"> {{ $position->description }} </textarea>
                                </div>
