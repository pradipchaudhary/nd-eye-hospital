    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Edit Gallery</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                        <li class="breadcrumb-item active">Edit Galllery</li>
                    </ol>
                </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="custom-validation" action="{{ route('update-gallery',$programs->id ) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            ...
                            <div>
                                ...
                                placeholder="Enter Slider Title" value="{{ $programs->title }} " />
                            </div>
                        </div>
