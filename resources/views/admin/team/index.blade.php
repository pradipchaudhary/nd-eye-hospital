                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <button class="d-btn btn-primary  mr-2">
                                        <a href="{{ route('edit-team', $item->id) }}" class="text-light"
                                        data-toggle="tooltip" data-placement="top" title=""
                                        data-original-title="Edit"><i
                                            class="mdi mdi-pencil font-size-18"></i></a>
                                    </button>
                                    {{-- Delete btn --}}
                                    <form class="" action="{{ route('delete-team', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Team Member Information</h5>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="row">
                                                                        <ul class="notice-list notice-info-list">
                                                                            ...
                                                                            <li class="col-md-12">
                                                                                <strong>Social Link : </strong> <br /> <span> {!! $item->fb_url !!}</span>
                                                                            </li>
                                                                            ...
                                                                            <li class="col-md-12">
                                                                                <strong>Images : </strong> <br /> <span>
                                                                                    @if ($item->image)
                                                                                    <img class="w-30" src="{{ asset('uploads/team/'.$item->image) }}"
