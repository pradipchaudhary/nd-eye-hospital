        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">View Services</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-sm-right">
                            <a href="{{ route('add-service') }}" type="button"
                                class="btn btn-primary btn-rounded waves-effect waves-light mb-2 mr-2"><i
                                    class="bx bx-arrow-back mr-1"></i> Add Services </a>
                        </div>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                @foreach ($services as $key => $item)
                                    <tr>
                                        <td> {{ $key + 1 }}</td>
                                        <td>{{ $item->categories != null ? $item->categories->name : '' }}</td>
                                        <td>
                                            {{ $item->title }}
                                        </td class="limit-description">
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <button class="d-btn btn-primary  mr-2">
                                                <a href="{{ route('edit-service', $item->id) }}" class="text-light"
                                                    data-toggle="tooltip" data-placement="top" title=""
                                                    data-original-title="Edit"><i
                                                        class="mdi mdi-pencil font-size-18"></i></a>
                                            </button>
                                            {{-- Delete btn --}}
                                            <form class="" action="{{ route('delete-service', $item->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                                            ...
                                                                            <div class="row">
                                                                                <ul class="notice-list notice-info-list">
                                                                                    <li class="col-md-12">
                                                                                        ...
                                                                                        <span>{{ $item->categories != null ? $item->categories->name : '' }}</span>
                                                                                    </li>
                                                                                    <li class="col-md-12">
                                                                                    ...
                                                                                    <li class="col-md-12">
                                                                                        ...
                                                                                        <span>
                                                                                            <img class="w-30"
                                                                                                src="{{ asset('uploads/service/' . $item->image) }}"
                                                                                                alt="service image" />
                                                                                        </span>
                                                                                    </li>
                                                                                </ul>
