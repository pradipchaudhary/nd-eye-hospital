                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-sm-right">
                            <a href="{{ route('add-publication') }}" type="button"
                                class="btn btn-primary btn-rounded waves-effect waves-light mb-2 mr-2"><i
                                    class="bx bx-arrow-back mr-1"></i> Add Publication </a>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <button class="d-btn btn-primary  mr-2">
                                                <a href="{{ route('edit-publication', $item->id) }}"
                                            ...
                                            <button class="btn-danger d-btn">
                                                <a href=" {{ route('delete-publication', $item->id) }}">
