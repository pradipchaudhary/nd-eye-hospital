                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <button class="d-btn btn-primary  mr-2">
                                        <a href="{{ route('edit-testimonial', $item->id) }}" class="text-light"
                                        data-toggle="tooltip" data-placement="top" title=""
                                        data-original-title="Edit"><i
                                            class="mdi mdi-pencil font-size-18"></i></a>
                                    </button>
                                    {{-- Delete btn --}}
                                    <form class="" action="{{ route('delete-testimonial', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Testimonial Information</h5>
                                                                        ...
                                                                        <ul class="notice-list notice-info-list">
                                                                            ...
                                                                            <li class="col-md-12">
                                                                                <strong>Images : </strong> <br /> <span>
                                                                                    @if ($item->image)
                                                                                    <img class="w-20" src="{{ asset('uploads/testimonial/'.$item->image) }}"
                                                                                    alt="News  image" /> </span>
                                                                                    @else
